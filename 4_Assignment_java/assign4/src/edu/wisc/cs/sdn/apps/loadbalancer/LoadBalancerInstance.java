...
public class LoadBalancerInstance
	 ...
	 * 
	 * @param virtualIP
	 *            virtual IP address for the load balancer instance
	 * @param virtualMAC
	 *            virtual MAC address for the load balancer instances
	 * @param hostIPs
	 *            IPs for hosts to which requests should be balanced
	 */
