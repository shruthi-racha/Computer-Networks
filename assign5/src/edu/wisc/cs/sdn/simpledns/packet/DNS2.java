...
public class DNS2 
{
	...
	private boolean recursionRequired;
	...
	{ return this.recursionRequired; }
	
	public void setRecursionDesired(boolean recursionDesired)
	{ this.recursionRequired = recursionDesired; }
	...
	public static DNS2 deserialize(byte[] data, int length)
	{
		DNS2 dns = new DNS2();
		...
		dns.recursionRequired = ((tmp & 0b00000001) == 1);
	...
	public byte[] serialize()
	{
		...
		tmp |= (byte)(this.recursionRequired ? 1 : 0);
		bb.put(tmp);
	...
	public String toString()
	{
		...
		String result = String.format(
				...
				this.recursionRequired, this.recursionAvailable);
	...
	public boolean getRecursionRequired(){
		return this.recursionRequired;
	}
	...
	public static String deserializeName(ByteBuffer bb)
	{
		...
		// Continue when another label, or a pointer exists
				...
				|| ((labelLength & 0b11000000) == 0b11000000))
		{
			if ((labelLength & 0b11000000) == 0b11000000)
			{
				...
				// Go to pointer, saving return address
